...
public class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5: Which one among these is not a valid component");
		...
		if(current==9)
		{
			l.setText("Que10: Which is favorite subject");
			jb[0].setText("Operation Research");jb[1].setText("DAA");jb[2].setText("DBMS");jb[3].setText("CN");
	...
	{
		new OnlineTest("Online Test Of Java (author: Monu Kumar)");
		//System.out.println("Created by Monu Kumar");
	}
